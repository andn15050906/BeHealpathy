...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.McqAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.McqChoice", b =>
                {
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.McqQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.MentalProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.Roadmap", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.RoadmapMilestone", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.RoadmapPhase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.RoadmapRecommendation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.Submission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.Survey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.SurveyScoreBand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Contract.Domain.UserAggregate.UserStatistics", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.McqAnswer", b =>
                {
                    b.HasOne("Contract.Domain.ProgressAggregate.McqQuestion", null)
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.McqChoice", b =>
                {
                    b.HasOne("Contract.Domain.ProgressAggregate.McqAnswer", "Answer")
                        .WithMany()
                        .HasForeignKey("McqAnswerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Contract.Domain.ProgressAggregate.Submission", "Submission")
                        .WithMany("Choices")
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.McqQuestion", b =>
                {
                    b.HasOne("Contract.Domain.ProgressAggregate.Survey", null)
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.RoadmapMilestone", b =>
                {
                    b.HasOne("Contract.Domain.ProgressAggregate.RoadmapPhase", null)
                        .WithMany("Milestones")
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.RoadmapPhase", b =>
                {
                    b.HasOne("Contract.Domain.ProgressAggregate.Roadmap", null)
                        .WithMany("Phases")
            ...
            modelBuilder.Entity("Contract.Domain.ProgressAggregate.Submission", b =>
                {
                    ...
                    b.HasOne("Contract.Domain.ProgressAggregate.Survey", "Survey")
                        .WithMany()
                        .HasForeignKey("SurveyId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Contract.Domain.UserAggregate.User", b =>
                {
                    ...
                    b.HasOne("Contract.Domain.ProgressAggregate.MentalProfile", "MentalProfile")
                        .WithMany()
